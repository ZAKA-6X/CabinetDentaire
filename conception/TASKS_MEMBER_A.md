# Tâches — Membre A (Backend)
**Deadline:** 24 mai 2026 | **Stack:** Laravel 11 + MySQL  
**Role:** Backend — Laravel, BDD, API REST
...
## Semaine 2 — Backend + Auth (28 avril – 4 mai)
...
- [ ] Session test croisé : Tester toutes les pages Frontend + répondre aux bugs Membre B

---

## Semaine 5 — Documentation & Soumission
...
- [ ] Confirmer format token Sanctum avec Membre B
- [ ] Merger `backend` + `frontend` → `main`
- [ ] Relecture `README.md` final avec Membre B

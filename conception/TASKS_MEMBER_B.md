# Tâches — Membre B (Frontend)
**Deadline:** 24 mai 2026 | **Stack:** React + Axios  
**Role:** Frontend — React, UI, intégration API
...
- [ ] Session test croisé : Tester tous les endpoints Postman + signaler bugs à Membre A
...
- [ ] Confirmer format token Sanctum avec Membre A
- [ ] Merger `backend` + `frontend` → `main`
- [ ] Relecture `README.md` final avec Membre A

...
function Layout({ children }) {
  ...
  const getNavLinks = () => {
    ...
    if (user?.role === 'DENTISTE') return [
      ...
      { icon: 'cal', label: 'Agenda du jour', path: '/dentiste/agenda' },
  ...
  const NavIcon = ({ type }) => {
    const icons = {
      ...
      visit: <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 12h6M9 16h4"/></svg>,
      ...
      <div style={{
        ...
        {collapsed ? (
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', paddingBottom: '22px', borderBottom: '1px solid var(--line)', marginBottom: '8px' }}>
            <div style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'var(--accent)', color: '#fff', display: 'grid', placeItems: 'center', fontFamily: "'Fraunces', serif", fontWeight: '600', fontSize: '13px', flexShrink: 0, letterSpacing: '-0.02em' }}>HZ</div>
            <div>
      ...
      <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '18px 40px', display: 'flex', alignItems: 'center', gap: '16px', borderBottom: '1px solid var(--line)', background: 'var(--bg)', position: 'sticky', top: 0, zIndex: 5 }}>
          <span style={{ color: 'var(--ink-3)', fontSize: '12.5px' }}>
            HZ Dentaire &nbsp;/&nbsp; <b style={{ color: 'var(--ink)', fontWeight: '500' }}>
